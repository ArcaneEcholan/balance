      ...
      <div class="flex" style="height: 100%;">
        <div class="flexg2 flex column">
          <div class="flex flexg1">
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">1</clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">2</clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">3</clickable>
          </div>
          <div class="flex flexg1">
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">4</clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">5</clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">6</clickable>
          </div>
          <div class="flex flexg1">
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">7</clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">8</clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">9</clickable>
          </div>
          <div class="flex flexg1">
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">.</clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell">0</clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell delete">
              <van-icon name="cross"/>
            </clickable>
          </div>
        </div>
        <div class="flexg1 flex column">
          <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell" @click="focusOnPreviousRow">
            <van-icon name="arrow-up"/>
          </clickable>
          <div class="flex flexg1">
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell " @click="focusPrevious()">
              <van-icon name="arrow-left"/>
            </clickable>
            <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell" @click="focusNext()">
              <van-icon name="arrow"/>
            </clickable>
          </div>
          <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell" @click="focusOnNextRow">
            <van-icon name="arrow-down"/>
          </clickable>
          <clickable @touchend="touchKeyBoardEnd" class="flexg1 flex center cell" @click="onAddTrans">
            OK
          </clickable>
        </div>
      </div>
...
export default class AddTransactionEditorComponent extends Vue {
  ...
  touchKeyBoardEnd(event: any) {
    let c = event.target.closest(".cell")
